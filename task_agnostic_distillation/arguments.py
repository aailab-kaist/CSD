...
def add_model_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--loss-temp", type=float, default=1.0)
    group.add_argument("--abl-type", type=str, default="US")
    group.add_argument("--normalize", type=str, default="none")
    group.add_argument("--weighting", type=str, default="none")
    return parser
